...
function postElement(post) {
    // new
    const a = create('a', 'bg-gray-300 ml-24 mr-24 rounded-xl mb-5', null);
    ...
    const code = create('code', 'bg-black ml-5 flex mr-5 rounded-md pb-5 pt-2 pl-2 pr-2', post.pattern);
